...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::match(['get', 'post'], '/expenses-report', function () {
    //     return view('expenses-report');
    // })->middleware('role:admin,finance_officer')->name('expenses-report');
...
// Route::get('/expenses-report', [ExpensesReportController::class, 'index'])->name('expenses-report');
